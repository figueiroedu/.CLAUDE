...
- Aways use type instead interface
- Always destructure props in function signature
- Use default values: `{ size = 'md' }: Props`
- Spread remaining props: `{ className, ...rest }`
- Never use a value obtained through an API request as a prop; always call a custom hook to retrieve the cached value within the component.
